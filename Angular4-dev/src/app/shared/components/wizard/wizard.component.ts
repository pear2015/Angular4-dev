...
export class WizardComponent implements AfterContentInit {
  ...
  @Output() analysisEvent = new EventEmitter();
  ...
  /*  set steps(steps: Array<WizardStepComponent>) {
     this._steps = steps;
   } */
  ...
  public next(): void {
    if (this.activeStep.crimeList === false) {
  ...
  public analysisEmit(e) {
    this.analysisEvent.emit(e);
  }
}
